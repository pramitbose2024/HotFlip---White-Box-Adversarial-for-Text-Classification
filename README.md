...
Computes gradients of the loss with respect to input embeddings

Identifies the most influential token

Replaces that token to maximize model loss

Causes misclassification with minimal perturbation
